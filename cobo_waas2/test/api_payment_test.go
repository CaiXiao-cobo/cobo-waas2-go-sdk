...
func Test_cobo_waas2_PaymentAPIService(t *testing.T) {
	...
	t.Run("Test PaymentAPIService CreateSdkLink", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.PaymentAPI.CreateSdkLink(ctx).Execute()
	...
	t.Run("Test PaymentAPIService ListBulkSends", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.PaymentAPI.ListBulkSends(ctx).Execute()
